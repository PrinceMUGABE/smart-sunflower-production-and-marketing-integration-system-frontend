...
const Customer_Header = () => {
  ...
  const Navbar_Links = [
    ...
    { id: 1, name: "Sales", path: "/officer/sales", icon: <MdInsights className="text-xl" /> },
    { id: 2, name: "Stocks", path: "/officer/stocks", icon: <FaCashRegister className="text-xl" /> },
    { id: 3, name: "Feedbacks", path: "/officer/feedbacks", icon: <FaCashRegister className="text-xl" /> },
    { id: 4, name: "Predictions", path: "/officer/predictions", icon: <BarChart3 className="text-xl" /> },
    { id: 5, name: "Datasets", path: "/officer/datasets", icon: <Database size={20} /> },
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <Link to="/officer/predictions" className="flex items-center">
