...
function DriverExpenses() {
              ...
              currentexpenses.map((expense, index) => (
                <tr key={expense.id} className="bg-white">
                  ...
                  <td className="px-6 py-4">
                    ...
                    <Link
                      to={`/driver/editExpense/${expense.id}`}
  ...
  <button
    ...
    className="px-2 py-1 md:px-4 md:py-2 bg-blue-700 text-white rounded text-sm md:text-base disabled:opacity-50"
  >
    Prev
  </button>
  <span className="mx-2 text-base md:text-lg">{currentPage}</span>
  <button
