...
function UserProfile() {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      if (!accessToken) {
        ...
        setError(t("Authentication error. Please log in again."));
        return;
      }
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePhone(formData.phone_number)) {
      setError(t("Phone number must be 10 digits and start with 078, 072, 079, or 073."));
      return;
    }

    if (!validateEmail(formData.email)) {
      setError(t("Email must be a valid Gmail address ending with @gmail.com."));
      return;
    }
        ...
        <div className="bg-yellow-900 rounded-lg shadow-xl overflow-hidden">
          <div className="p-6 bg-yellow-600 text-white">
            ...
            <p className="text-yellow-100 mt-1">
              {isEditing
                ? t("Edit your profile details below")
                : t("Your personal account details")}
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="p-4 bg-yellow-800 border border-yellow-700 rounded-lg flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-white text-lg">
                        {new Date(userData.created_at).toLocaleDateString()} {t("at")}{" "}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder={t("e.g., example@gmail.com")}
                        className="w-full p-3 pl-10 bg-yellow-800 border border-yellow-700 rounded-md text-white placeholder-yellow-500 focus:outline-none focus:ring-2 focus:ring-red-600"
                        required
                      />
                    </div>
