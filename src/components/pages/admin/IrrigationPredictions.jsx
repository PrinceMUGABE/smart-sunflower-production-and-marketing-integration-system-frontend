...
const AdminManageIrrigationPredictions = () => {
  ...
  const renderMobileCard = (prediction) => (
    <div className="bg-white p-4 rounded-lg shadow-sm border border-yellow-100 space-y-3">
      ...
      <div className="flex justify-end space-x-2 pt-2">
        <button
          ...
          className="p-2 text-yellow-700 hover:text-yellow-800 rounded-lg hover:bg-yellow-50"
        >
  ...
  return (
    <div className="w-full px-12 ml-4">
      <h1 className="text-xl font-bold mb-4 text-yellow-700 text-center">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-4 space-y-2 md:space-y-0">
        <div className="flex items-center space-x-2">
          <button
            ...
            className="px-4 py-2 bg-yellow-600 text-white rounded-md flex items-center space-x-2 hover:bg-yellow-700"
          >
              ...
              <div className="absolute z-10 mt-2 w-48 bg-white rounded-md shadow-lg">
                <div className="py-1">
                  <button
                    ...
                    className="block px-4 py-2 text-sm text-yellow-700 hover:bg-yellow-100 w-full text-left"
                  >
                    Download as PDF
                  </button>
                  <button
        ...
        <div className="relative w-full md:w-auto">
          <Search className="h-5 w-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-yellow-400" />
          <input
            type="text"
            placeholder="Search..."
            value={searchTerm}
            ...
            className="w-full md:w-auto text-yellow-700 pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"
          />
        </div>
      </div>
              ...
              <div className="hidden lg:block overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="bg-white divide-y divide-yellow-200">
                    {paginatedPredictions.map((prediction) => (
                      <tr key={prediction.id} className="hover:bg-yellow-50">
                        <td className="px-6 py-4 whitespace-nowrap font-medium text-yellow-900">
                          {prediction.location || "N/A"}
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <div className="flex justify-end space-x-2">
                            <button
                              onClick={() => handleViewDetails(prediction.id)}
                              className="p-2 text-yellow-700 hover:text-yellow-800 rounded-full hover:bg-yellow-50"
                            >
                              <Eye className="h-5 w-5" />
                            </button>
                            <button
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mt-4 space-y-2 md:space-y-0">
        <select
          ...
          className="border rounded-md px-2 py-1 text-yellow-700"
        >
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className="p-1 rounded-full hover:bg-yellow-100 disabled:opacity-50"
          >
          ...
          {!predictionResult ? (
            <form onSubmit={handleCreatePrediction} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 text-yellow-700 block w-full rounded-md border-yellow-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500"
                  required
                  disabled={isLoading}
              ...
              <div>
                ...
                <select
                  ...
                  className={`mt-1 block w-full rounded-md border-yellow-300 shadow-sm 
              focus:border-yellow-500 focus:ring-yellow-500 text-yellow-700
              ${!district && "bg-yellow-100 cursor-not-allowed"}`}
                  required
              ...
              <div className="flex justify-end space-x-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-sm font-medium text-white bg-yellow-700 rounded-md hover:bg-yellow-400 disabled:opacity-50"
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end">
                <button
                  onClick={handleClose}
                  className="px-4 py-2 text-sm font-medium text-white bg-yellow-700 rounded-md hover:bg-yellow-700"
                >
                  Close
                </button>
              </div>
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 max-w-4xl h-full overflow-y-auto bg-white rounded-lg shadow-xl">
          <div className="sticky top-0 bg-white p-4 border-b border-yellow-200 z-10 mt-16">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="p-2 text-yellow-500 hover:text-yellow-700 rounded-full hover:bg-yellow-100 transition-colors"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
          ...
          {selectedPrediction && (
            <div className="p-6 space-y-6 mt-24">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg py-12">
                <h3 className="font-semibold mb-3 text-yellow-900">
                  Location Information
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div>
                    <p className="text-sm text-yellow-600">Location</p>
                    <p className="font-medium text-yellow-600">
                      {selectedPrediction.location}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Coordinates</p>
                    <p className="font-medium text-yellow-600">
                  ...
                  <div>
                    <p className="text-sm text-yellow-600">Elevation</p>
                    <p className="font-medium text-yellow-600">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <p className="text-sm text-yellow-600">Temperature</p>
                    <p className="font-medium text-yellow-600">
                      {formatValue(selectedPrediction.temperature)}°C
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Humidity</p>
                    <p className="font-medium text-yellow-600">
                  ...
                  <div>
                    <p className="text-sm text-yellow-600">Rainfall</p>
                    <p className="font-medium text-yellow-600">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <p className="text-sm text-yellow-600">Soil Type</p>
                    <p className="font-medium text-yellow-600">
                      {selectedPrediction.soil_type}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">pH</p>
                    <p className="font-medium text-yellow-600">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <p className="text-sm text-yellow-600">Nitrogen</p>
                    <p className="font-medium text-yellow-600">
                      {formatValue(selectedPrediction.nitrogen)}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Phosphorus</p>
                    <p className="font-medium text-yellow-600">
                      {formatValue(selectedPrediction.phosphorus)}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Potassium</p>
                    <p className="font-medium text-yellow-600">
                      {formatValue(selectedPrediction.potassium)}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Zinc</p>
                    <p className="font-medium text-yellow-600">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-yellow-600">Predicted Crop</p>
                    <p className="font-medium text-yellow-600">
                      {selectedPrediction.predicted_crop}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Water Requirement</p>
                    <p className="font-medium text-yellow-600">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div>
                    <p className="text-sm text-yellow-600">Phone Number</p>
                    <p className="font-medium text-yellow-700">
                      {selectedPrediction.created_by?.phone_number}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-yellow-600">Email</p>
                    <p className="font-medium text-yellow-700">
                      {selectedPrediction.created_by?.email}
                    </p>
                  </div>
                  <div className="ml-4">
                    <p className="text-sm text-yellow-600">Created At</p>
                    <p className="font-medium text-yellow-700">
