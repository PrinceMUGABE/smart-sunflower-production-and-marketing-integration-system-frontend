...
import loginImage from "../../assets/pictures/coaster.jpg"; // Assuming the path to the image
...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Validate phone and password before proceeding
      ...
      .then((res) => {
        ...
        if (res.data) {
          ...
          const user = {
            ...
            phone: res.data.phone_number, // Ensure the key matches the API response
            refresh_token: res.data.token.refresh,
            access_token: res.data.token.access,
          };
  
          // Save all the user data in localStorage
          localStorage.setItem("userData", JSON.stringify(user));
          localStorage.setItem("token", res.data.token.access);
  
          // Log the user data to the console
          console.log("Stored User Data:", user);
          console.log("Stored Access Token:", res.data.token.access);
  ...
  return (
    <div className="flex justify-center items-center min-h-screen py-4  h-full bg-gray-50">
      ...
      <div className="grid lg:grid-cols-2 rounded-lg shadow-xl w-full max-w-4xl overflow-hidden">
        ...
        {/* Right side - Form */}
        <div className="flex items-center justify-center bg-white py-6 px-4 lg:px-8 w-full">
          <div className="sm:max-w-md w-full max-w-sm mx-auto">
